...
st.markdown("""
<!-- COLOR1 -->
<div style="background:linear-gradient(135deg,#0606f6 0%,#06ebef 60%,#0116f8 100%);
...
with st.form("triage_form"):
    ...
    <div style="background:#1d09f6;border:1px solid #5c0ddc;border-radius:14px;
        ...
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            ...
            <span style="font-size:16px;font-weight:600;color:#efefef;">How long have you had these symptoms?</span>
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    st.markdown("""
    <!-- COLOR4 -->
    <div style="background:#0408eb;border:1px solid #100ddc;border-radius:14px;
                padding:20px 24px;margin-bottom:20px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            <span style="background:#25f20a;color:white;border-radius:8px;
                         padding:4px 10px;font-size:12px;font-weight:600;">3</span>
            <span style="font-size:16px;font-weight:600;color:#f0f0f2;">How would you rate the severity?</span>
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    st.markdown("""
    <!-- COLOR5 -->
    <div style="background:#1909f6;border:1px solid #1b0ddc;border-radius:14px;
                padding:20px 24px;margin-bottom:20px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            <span style="background:#25f20a;color:white;border-radius:8px;
                         padding:4px 10px;font-size:12px;font-weight:600;">4</span>
            <span style="font-size:16px;font-weight:600;color:#f7f7f7;">Do you have any of the following?</span>
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    st.markdown("""
    <!-- COLOR6 -->
    <div style="background:#4c09f6;border:1px solid #2c0ddc;border-radius:14px;
                padding:20px 24px;margin-bottom:20px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            <span style="background:#25f20a;color:white;border-radius:8px;
                         padding:4px 10px;font-size:12px;font-weight:600;">5</span>
            <span style="font-size:16px;font-weight:600;color:#f6f6f6;">Patient Information</span>
        </div>
    </div>
    """, unsafe_allow_html=True)
